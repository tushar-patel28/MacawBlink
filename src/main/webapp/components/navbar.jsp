...
<div class="container-fluid">
  <a class="navbar-brand text-light " href="index.jsp"><h3><i>MacawBlink</i></h3></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    %>
                 <li class="nav-item active">
                    <a class="nav-link text-light" href="admin.jsp"><b>Admin Page</b> <span class="sr-only">(current)</span></a>
                 </li>
    <%
        	 }
         }
    %>
      ...
      <li class="nav-item active ml-2" data-toggle="modal" data-target=".aboutusmodal">
          <div class="nav-link text-light" ><b>About us</b></div>
      </li>
      
      <li class="nav-item active ml-2" data-toggle="modal" data-target=".contactusmodal">
          <div class="nav-link text-light" ><b>Contact us</b></div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              %>
                     <li class="nav-item active" data-toggle="modal" data-target="#showmycartmodal">
                        <div class="nav-link text-light"><img src="images/cart.png" style="width:23px;" alt="img">(<%=new CartDaoImp().totalCartByUserId(user.getUserId()) %>)</div>
                     </li> 
                     
                     <li class="nav-item active" data-toggle="modal" data-target="#showmyordermodal">
                        <a class="nav-link text-light" href="#"><b>My Orders</b></a>
                     </li>
              <%
                  }
              %>
             ...
             <li class="nav-item active">
             <div class="nav-link text-light" data-toggle="modal" data-target="#showprofilemodal"><b><%= user.getUserName()%></b></div>
             </li> 
             
             <li class="nav-item active">
             <div class="nav-link text-light" data-toggle="modal" data-target=".changepasswordmodal"><b>Change Password</b></div>
             </li>  
    ...
    <ul class="navbar-nav ml-auto">
       <li class="nav-item active">
        <div class="nav-link text-light" data-toggle="modal" data-target=".forgetpasswordmodal"><b>Forget password</b></div>
      </li> 
    
      <li class="nav-item active">
        <a class="nav-link text-light" href="register.jsp"><b>Register</b></a>
      </li>  
      
      <li class="nav-item active">
        <a class="nav-link text-light" href="login.jsp"><b>Login</b></a>
      </li>    
    </ul>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header custom-bg text-white text-center">
        <h5 class="modal-title text-light" id="exampleModalLongTitle" >MY PROFILE</h5>
...
<div class="modal fade" id="showmycartmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header custom-bg text-white text-center">
        <h5 class="modal-title text-light" id="exampleModalLongTitle" >MY CART</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="showmyordermodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-size" role="document">
    <div class="modal-content">
      <div class="modal-header custom-bg text-white text-center">
        <h5 class="modal-title text-light" id="exampleModalLongTitle" >MY ORDERS</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
