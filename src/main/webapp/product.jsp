...
<div class="container-fluid">
  ...
  <div class="form-group">
     ...
     <select class="form-control bg-dark text-light text-center" id="brand" name="brandId">
     ...
     <select class="form-control bg-dark text-light text-center mt-3" id="cloth" name="clothId">
     ...
     <select class="form-control bg-dark text-light text-center mt-3" id="type" name="productFT">
  ...
  <button type="submit" class="btn bg-dark text-light" style="width:200px;">Search</button>
                    ...
                    <div class="text-left ml-4 mt-3"><h2>Description :</h2></div>
                        ...
                        <div class="card-footer text-center">
                               ...
                               <form class="form-inline" onclick="return checkUser()">
                                  ...
                                  <button type="submit" class="btn bg-dark text-white mb-2">Add To Cart</button>
                               </form>
                              ...
                              %> 
                                      ...
                                      <button type="button" class="btn bg-dark text-light text-light ml-5" data-toggle="modal" data-target="#update-product-modal">Update Product</button>
                                      ...
                                      %>
                                               ...
                                               <input type="submit" class="btn bg-dark  text-white mb-2" value="Add To Cart">
